...
<div class="container my-5">
    ...
    <div class="card p-4 shadow-sm">
        ...
        <p><strong>Apakah Anda pernah memiliki pengalaman membawa tamu yang memiliki banyak permintaan dan selalu komplain?:</strong> {{ $guide->pengalaman_komplain }}</p>
        <p><strong>Bagaimana Anda menyikapi komplain dari tamu tersebut?:</strong> {{ $guide->menyikapi_komplain }}</p>
        <p><strong>Bagaimana Anda menyiasati agar tour tetap berjalan dengan lancar meskipun sudah terdeteksi potensi hambatan sejak awal?:</strong> {{ $guide->menyiasati_hambatan }}</p>
        <p><strong>Di masa depan rencana apa yang telah Anda siapkan untuk meningkatkan layanan Anda sebagai tour guide?:</strong> {{ $guide->rencana_meningkatkan_layanan }}</p>
