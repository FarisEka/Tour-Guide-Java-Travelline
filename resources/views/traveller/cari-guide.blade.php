...
<div class="container my-5">
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="domisili_hpi" id="domisili_hpi" class="form-control shadow-sm" placeholder="Cari domisili..." value="{{ request('domisili') }}">
    </div>
            ...
            <div class="col">
                <div class="card h-100 text-center border-0 shadow-lg rounded-4 p-4  hover-shadow">
                    ...
                    <div class="card-body p-0">
                        ...
                        <p class="mb-1 text-muted fs-6">{{ $tourGuide->usia ?? '-' }} tahun &bullet; {{ $tourGuide->domisili_hpi }}</p>
                        <p class="small text-secondary fst-italic mt-2">{{ $tourGuide->alasan_profesi }}</p>
                    </div>

                    <div class="mt-4">
                        <a href="#" class="btn btn-success w-100 rounded-pill fw-semibold shadow-sm">Ajukan Permintaan</a>
                    </div>
                </div>
            </div>
        @empty
